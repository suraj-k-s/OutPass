...
//checking if request cotains multipart data
    ...
    String InsQry = "INSERT INTO tbl_student( student_name, student_contact,student_email,student_address,student_password,student_photo,student_doj,hostel_id,place_id)"
            + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + photo + "',curdate(),'" + value[5] + "','" + value[7] + "')";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Warden/Student.jsp'
