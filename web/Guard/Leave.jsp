...
<html lang="en" >
    ...
    <%
        if (request.getParameter("id") != null) {
            ...
            String upQry = "update tbl_leave set leave_status='" + request.getParameter("sts") + "' where leave_id='" + request.getParameter("id") + "'";
    ...
    %>
    <body>
        <h1 align="center" id="heading">Leave Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_leave l inner join tbl_student s on s.student_id=l.student_id inner join tbl_hostel h on h.hostel_id=s.hostel_id inner join tbl_guard g on g.hostel_id=h.hostel_id where g.guard_id='" + session.getAttribute("gid") + "'";
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        %>
                        Warden Accepted | <a href="Leave.jsp?id=<%=rs.getString("leave_id")%>&sts=2"><img src="../Assets/Template/admin/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="Leave.jsp?id=<%=rs.getString("leave_id")%>&sts=3"><img src="../Assets/Template/admin/remove.png"  width="25" height="25"></a>
                            <%
...
//                                                    }
                                        ...
                                        // Right side: curleave page and total pages
