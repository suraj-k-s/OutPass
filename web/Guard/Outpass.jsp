...
<html lang="en" >
    ...
    <%
        if (request.getParameter("id") != null) {
            ...
            String upQry = "update tbl_outpass set outpass_status='" + request.getParameter("sts") + "' where outpass_id='" + request.getParameter("id") + "'";
    ...
    %>
    <body>
        <h1 align="center" id="heading">Outpass Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_outpass l inner join tbl_student s on s.student_id=l.student_id inner join tbl_hostel h on h.hostel_id=s.hostel_id inner join tbl_guard g on g.hostel_id=h.hostel_id where g.guard_id='" + session.getAttribute("gid") + "'";
                ...
                <tr>
                   ...
                   <td><%=rs.getString("outpass_date")%></td>
                    ...
                    <td align="center">
                        ...
                        %>
                        Warden Accepted | <a href="Outpass.jsp?id=<%=rs.getString("outpass_id")%>&sts=2"><img src="../Assets/Template/admin/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="Outpass.jsp?id=<%=rs.getString("outpass_id")%>&sts=3"><img src="../Assets/Template/admin/remove.png"  width="25" height="25"></a>
                            <%
...
//                                                    }
                                        ...
                                        // Right side: curoutpass page and total pages
