...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_leave l inner join tbl_student s on s.student_id=l.student_id inner join tbl_hostel h on h.hostel_id=s.hostel_id where warden_id='" + session.getAttribute("wid") + "'";
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        %>
                        <a href="Leave.jsp?id=<%=rs.getString("leave_id")%>&sts=1"><img src="../Assets/Template/admin/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
